...
import {
  ...
  Input,
  TestNumCopy,
} from "../component/style/Ask.styled";
...
const Ask = () => {
  ...
  const submitPay = (e) => {
    ...
    TPDirect.card.getPrime(function (result) {
      ...
      fetch(
        "https://us-central1-coffee-chat-together.cloudfunctions.net/getPay",
        {
          method: "POST",
          headers: {
  ...
  return (
    <main>
      <AskForm>
        ...
        <QuestionBox>
          <Notification>
            提問前可以提供您認為有助分享者回覆您問題的相關個人資訊。讓{" "}
            {consultantName} 能更準確地回覆您的提問。
          </Notification>
          <SingleQuestion>
            <div>
        ...
        <PaymentBox>
          <Notification>
            Buy me a coffee!
            <br />
            填寫付款資訊，您將請 {consultantName} 喝一杯 95 元咖啡。
          </Notification>
          <PaymentInputBox>
            <InputLabel>
            ...
            <TestNumCopy>
              測試卡號
              <textarea rows="1" readOnly value={"4242424242424242"}></textarea>
              <div onClick={copyNum}>Copy</div>
            </TestNumCopy>
            ...
            <TestNumCopy>
              測試日期<textarea rows="1" readOnly value={"0123"}></textarea>
              <div onClick={copyNum}>Copy</div>
            </TestNumCopy>
            ...
            <TestNumCopy>
              測試安全碼<textarea rows="1" readOnly value={"123"}></textarea>
              <div onClick={copyNum}>Copy</div>
            </TestNumCopy>
          </PaymentInputBox>
        </PaymentBox>
        <Button type="submit" onClick={submitPay}>
          提交諮詢
        </Button>
      </AskForm>
    </main>
