    ...
    return(
        <div className="project">
            ...
            <div className="type-discript-box">
                <select name="project-type" onChange={getSelectValue}>
                    <option>請選擇</option>
                    <option>文章</option>
                    <option>作品</option>
                </select>
                <textarea placeholder="連結說明" onChange={getContent}></textarea>
            </div>
            </div>
            <input className="project-link" type="text" placeholder="在此貼上作品/文章連結" onChange={getLink} ></input>
        </div>
    )
}
